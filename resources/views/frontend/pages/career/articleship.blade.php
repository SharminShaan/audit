                ...
                <div class="col-lg-6 col-md-6 order-0 order-lg-2">
                    <div class="">
                        <div class="section-title mb-30 tg-heading-subheading animation-style2">
                            ...
                            <p>
                                The candidates should have good written
                                and verbal communication skills,
                                analytical ability, strong academic
                                background, computer literacy and a
                                passion to learn and attain newer skills
                                with time.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="about-content-two">
                        <div class="section-title mb-30 tg-heading-subheading animation-style2">
                            ...
                            <p>
                                We are looking to accommodate our
                                growing level of activities with
                                Articled Students/Trainees who opt for a
                                bright career in the field of
                                accountancy.
                            </p>
                        </div>
                    </div>
